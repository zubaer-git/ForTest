...
public class accCreatM extends DriverSetup {
	static String url = "http://202.84.45.54:9999/bexibank/f?p=222:101::::::";
...
//			userCount = userCount + 1;
			...
			if (accHolder <= 6) {
				bcl.findElement(By.xpath("//input[@id='P6001_F_NAME']")).sendKeys("Usr" + accHolder);
			}
...
//		sf.selectByIndex(0); 
			...
			String id = cmt.substring(cmt.indexOf('(') + 2, cmt.indexOf(')') - 1);      //=============imp
			Thread.sleep(5000);
...
//			bcl.findElement(By.className("a-Menu-label")).click(); //*[@id="t_MenuNav_0_1i"]
			Thread.sleep(1000);
			...
			Thread.sleep(1000);
//	        bcl.findElement(By.xpath("//input[@id='P6021_OPEN_DATE']")).sendKeys("01-Mar-2022");
//	        Thread.sleep(1000);
//	        bcl.findElement(By.xpath("//input[@id='P6021_OPEN_DATE']")).sendKeys(Keys.ENTER);
			bcl.findElement(By.xpath("//input[@id='P6021_OPEN_DATE']")).clear();
			Thread.sleep(1000);
...
//		    String s = formatter.format(new Date());
			...
			bcl.findElement(By.xpath("//input[@id='P6021_OPEN_DATE']")).sendKeys(s);
			Thread.sleep(1000);
			...
			bcl.findElement(By.xpath("//tbody/tr[2]/td[1]/a[1]")).click();
			Thread.sleep(1000);
			System.out.println("step-9");
//			bcl.findElement(By.xpath("//button[@id='B31883858845514842']")).click();
			bcl.findElement(By.xpath("//*[@id=\"B31883858845514842\"]")).click();
			Thread.sleep(1000);      
